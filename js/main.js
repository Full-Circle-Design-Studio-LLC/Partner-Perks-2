...
function loadMore() {
  ...
  moreCards.classList.toggle("load-more-company-cards-unhide");
  moreCards.classList.remove("load-more-company-cards");
  ...
  if (loadMore.innerHTML === "SHOW LESS") {
    ...
    //arrow.src = "<?php echo get_template_directory_uri(); ?>/assets/arrow.svg?";
    arrowDown.style.display = "block";
    arrowUp.style.display = "none";
    moreCards.classList.add("load-more-company-cards-hide");
  }
  else {
    loadMore.innerHTML = "SHOW LESS";
    //arrow.src = "<?php echo get_template_directory_uri(); ?>/assets/arrow-up.svg?";
    arrowUp.style.display = "block";
    arrowDown.style.display = "none";
    moreCards.classList.remove("load-more-company-cards-hide");
  }
}
